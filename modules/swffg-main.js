...
Hooks.once("init", async function () {
  ...
  const CODEX_ITEM_TYPES = ["weapon", "armour", "gear", "talent", "shipweapon", "ability", "criticalinjury", "criticaldamage", "obligation", "motivation", "background", "shipattachment", "homesteadupgrade"];
