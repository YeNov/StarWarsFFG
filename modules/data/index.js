 ...
 *
 * Stage 0 is intentionally empty — the maps stay untouched so template.json
 * remains the sole schema source and the system boots identically. As stages
 * land, add entries here, e.g.:
 *
...
export function registerSystemDataModels() {
  // Stage 0: no types registered yet.
}
