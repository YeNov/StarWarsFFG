...
import { buildSwaSkillDictionary } from "./swa-skills.js";
          ...
          if (fileData.length > 0) {
            ...
            await ImportHelpers.asyncForEach(fileData, async (item) => {
              try {
                ...
                // A complete dictionary, straight from the active skill theme. It cannot be a
                // partial one: `system.skills` is a DataModel TypedObjectField, so what is passed
                // to Actor.create REPLACES the default outright instead of merging over it (see
                // swa-skills.js).
                const skills = buildSwaSkillDictionary(CONFIG.FFG.alternateskilllists, skilltheme);
