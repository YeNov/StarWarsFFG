...
* Fixed — **ticked options in the Sheet Options window showed a small blank rectangle instead of a tick on Foundry V14.** Enable hyperdrive, Minion Vehicle and the other on/off options on actor and item sheets show their tick again, as on V13.
