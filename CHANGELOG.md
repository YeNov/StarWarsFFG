...
* Added — **the Codex sheet groups talents under "Tier 1", "Tier 2" ... headings** instead of one flat list, so it is easier to see where a character sits in a tree. A talent taken in more than one place is listed at the lowest tier it was found at. On by default; turn it off under Configure Codex → "Sort Talents by Tier".
