...
* Added — **one roll for all triggers** (p. 339): when a group uses more than one of Obligation, Duty and Morality, a single d100 can be rolled against all of them at once and reported as one message.
